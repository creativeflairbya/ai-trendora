...
export const MOCK_ASSETS: AssetData[] = [
  ...
  },
  {
    ...
    ema20: 4038.40,
    ema50: 4031.10,
    supportZone: [4035.00, 4038.00],
    resistanceZone: [4044.00, 4048.50],
    setupQuality: 'HIGH',
    candles: {
      '15m': generateCandles(4040.66, 2.1, 42),
      '1H': generateCandles(4040.66, 4.2, 42),
      '4H': generateCandles(4040.66, 9.5, 42),
      '1D': generateCandles(4040.66, 18.0, 42)
    },
    currentSignal: {
      action: 'BUY',
      entryZone: [4039.80, 4041.10],
      stopLoss: 4036.90,
      takeProfit1: 4044.80,
      takeProfit2: 4048.40,
      confidence: 99,
  ...
  ...[
    ['eth-usdt', 'ETH/USDT', 'Ethereum', 3320.75, 'ETHUSDT'],
    ['bnb-usdt', 'BNB/USDT', 'BNB Chain', 698.40, 'BNBUSDT'],
